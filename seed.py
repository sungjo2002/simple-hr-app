...
def seed_database() -> None:
    ...
    employees = [
        ...
        Employee(
            ...
            nationality="대한민국",
            phone="010-2222-2222",
            resident_number="920202-2234567",
            visa_type="내국인",
            address="경기 광명시 예시동 2-2",
            hire_date="2024-03-04",
            status="active",
            emergency_contact="010-9999-2222",
            emergency_relation="부모",
            bank_name="신한은행",
            bank_account="222222-22-222222",
            account_holder="박영희",
            memo="야간조 숙련",
        ),
        Employee(
            ...
            nationality="우즈베키스탄",
            phone="010-3333-3333",
            resident_number="930303-3234567",
            visa_type="H-2",
            address="서울 금천구 예시동 3-3",
            hire_date="2024-02-15",
            status="active",
            emergency_contact="010-9999-3333",
            emergency_relation="형제",
            bank_name="하나은행",
            bank_account="333333-33-333333",
            account_holder="장민수",
            memo="",
        ),
        Employee(
            ...
            nationality="대한민국",
            phone="010-4444-4444",
            resident_number="940404-4234567",
            visa_type="내국인",
            address="경기 안양시 예시동 4-4",
            hire_date="2024-01-20",
            status="active",
            emergency_contact="010-9999-4444",
            emergency_relation="부모",
            bank_name="우리은행",
            bank_account="444444-44-444444",
            account_holder="이수진",
            memo="병원 현장 담당",
        ),
    ]
