...
class AdminMenu(db.Model):
    ...
    route_path = db.Column(db.String(255), nullable=False, default="")
...
class AdminPage(db.Model):
    ...
    id = db.Column(db.Integer, primary_key=True)
    page_key = db.Column(db.String(80), nullable=False, unique=True)
...
class UiLabel(db.Model):
    __tablename__ = "ui_labels"

    id = db.Column(db.Integer, primary_key=True)
    label_key = db.Column(db.String(80), nullable=False, unique=True)
    label_text = db.Column(db.String(255), nullable=False)
    category = db.Column(db.String(80), nullable=False, default="general")
    description = db.Column(db.String(255), nullable=False, default="")
    is_active = db.Column(db.Boolean, nullable=False, default=True)
    created_at = db.Column(db.String(10), nullable=False, default=today_str)
