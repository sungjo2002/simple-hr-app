...
class Employee(db.Model):
    ...
    retirement_date = db.Column(db.String(10), nullable=False, default="")
    retirement_reason = db.Column(db.Text, nullable=False, default="")
    recontact_target = db.Column(db.String(1), nullable=False, default="N")
    next_contact_date = db.Column(db.String(10), nullable=False, default="")
    retirement_note = db.Column(db.Text, nullable=False, default="")
