...
def records_page() -> str:
    ...
    quick = [
        {
            "label": "근태조회",
            "href": f"/records?tab=all&client_company_id={selected_client_company_id or ''}&month={selected_month}",
            "active": selected_tab == "all",
        },
        {
            "label": "월별현황",
            "href": f"/records?tab=monthly&client_company_id={selected_client_company_id or ''}&month={selected_month}",
            "active": selected_tab == "monthly",
        },
    ]
